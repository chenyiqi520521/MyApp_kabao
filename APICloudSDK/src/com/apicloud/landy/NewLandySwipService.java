...
public class NewLandySwipService extends SwipApi{
    ...
    public NewLandySwipService(Activity activity,SwipUiHandler swipUIHandler,Handler mainHandler,int whatDo,Map<String, Object> params) {
   		...
   		public void handleMessage(Message msg) {
               ...
               case LandyListener.LOAD_TRACK_KEY_FAIL://导入磁道秘钥失败
				...
				case LandyListener.GET_DEVICE_INFO_SUCCESS://获取信息成功
					...
					ksn=info.clientSN+"";
					if(fromAct==UICommon.BindEquipmentActivity){
  ...
  //随机生成一个EnworkingKey
	...
	public void finishGetCardNo(LandyTackMsg lanyTrackMsg){
		...
		msg.what=NewSwipActivity.FINISH_GET_CARD_NO_SUCCESS;
	...
	public void finishEncrykSuccess(String pinBlock){
		Message msg=parentHandler.obtainMessage();
		msg.what=NewSwipActivity.FINISH_ENCRY_KEY_SUCCESS;
		msg.obj=pinBlock;
		parentHandler.sendMessage(msg);
	...
	public void finishWorkSuccess(LandyTackMsg lanyTrackMsg){
		Message msg=parentHandler.obtainMessage();
		msg.what=NewSwipActivity.FINISH_WORK_SUCCESS;
		msg.obj=lanyTrackMsg;
		parentHandler.sendMessage(msg);
	...
	public void finishWorkFali(){
		Message msg=parentHandler.obtainMessage();
		msg.what=NewSwipActivity.FINISH_WORK_FAIL;
		parentHandler.sendMessage(msg);
	}
